...
namespace ExanimaTools.Models
{
    ...
    // Extension methods for ILoggingService to provide LogDebug, LogInformation, etc.
    public static class LoggingServiceExtensions
    {
        public static void LogDebug(this ILoggingService logger, string message)
        {
            logger.Log($"[DEBUG] {message}");
        }
        public static void LogInformation(this ILoggingService logger, string message)
        {
            logger.Log($"[INFO] {message}");
        }
        public static void LogWarning(this ILoggingService logger, string message)
        {
            logger.Log($"[WARN] {message}");
        }
        public static void LogError(this ILoggingService logger, string message, Exception? ex = null)
        {
