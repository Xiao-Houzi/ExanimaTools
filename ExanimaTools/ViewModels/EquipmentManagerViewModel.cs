...
namespace ExanimaTools.ViewModels
{
    public class EquipmentManagerViewModel : INotifyPropertyChanged
    {
        ...
        public EquipmentManagerViewModel(EquipmentRepository equipmentRepository, ILoggingService logger)
        {
            _equipmentRepository = equipmentRepository ?? throw new ArgumentNullException(nameof(equipmentRepository));
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _logger.LogOperation("EquipmentManagerViewModel", "Created via DI");
        ...
        private EquipmentPiece newEquipment = null!; // Will be initialized in constructor
